...
class QuickList(models.Model):
  ...
  userName = models.CharField(max_length=10, db_column='user_name', verbose_name='用户姓名')
  ...
  complateRemark = models.CharField(max_length=500, db_column='complete_remark', verbose_name='完成备注')
